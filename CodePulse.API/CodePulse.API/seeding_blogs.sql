...
', N'https://images.pexels.com/photos/5483077/pexels-photo-5483077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'http-requests-javascript', N'Sameer Saini', NOW(), true);

    INSERT INTO "BlogPosts" ("Id", "Title", "ShortDescription", "Content", "FeaturedImageUrl", "UrlHandle", "Author", "PublishedDate", "IsVisible") VALUES (gen_random_uuid(), N'Building a Simple Web API Using C# and .NET Core: A Step-by-Step Guide', N'Building a robust and efficient web API is a fundamental skill for modern application development. In this comprehensive guide, we will walk you through the process of creating a simple web API using C# and .NET Core.', N'## Introduction
...
', N'https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'web-api-csharp', N'Sameer Saini', NOW(), true);

INSERT INTO "BlogPosts" ("Id", "Title", "ShortDescription", "Content", "FeaturedImageUrl", "UrlHandle", "Author", "PublishedDate", "IsVisible") VALUES (gen_random_uuid(), N'Reading an Excel File in C#: A Step-by-Step Guide', N'Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework', N'
...
', N'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'read-excel-csharp', N'Sameer Saini', NOW(), true);
...
', N'https://images.pexels.com/photos/16037283/pexels-photo-16037283/free-photo-of-open-laptop-on-desk.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'html-website-using-chatgpt', N'Sameer Saini', NOW(), true);

INSERT INTO "BlogPosts" ("Id", "Title", "ShortDescription", "Content", "FeaturedImageUrl", "UrlHandle", "Author", "PublishedDate", "IsVisible") VALUES (gen_random_uuid(), N'Creating a Simple Calculator Application using ASP.NET Core Console App', N'ASP.NET Core is a powerful framework for building cross-platform web applications. While it is commonly used for developing web applications, ASP.NET Core can also be leveraged to create console applications. In this blog post, we will explore in detail how to create a simple calculator application using ASP.NET Core console app. We will cover the step-by-step process of setting up the project, implementing the calculator logic, and running the application. So, let''s get started!', N'## Introduction
...
', N'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'simple-calculator-app-aspnet-core', N'Sameer Saini', NOW(), true);
